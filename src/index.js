...
class WebSocketAsPromised {
    ...
    _handleUnpackedData(data) {
        // It is possible for client code handling some kind message (binary message for example) in the onMessage
        // listener, and the options.unpackMessage() method may return undefined for discard follow-up handling.
        if (data === undefined)
            return;
